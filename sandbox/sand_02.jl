...
#using StaticArrays
"""
    Sand 02: advection of a scalar, with abrupt step in velocity (as a function of position)
"""
...
mutable struct ring
    ...
    ∇U_::Array{Float64,1}   # divergence of velocity (on cells)
...
function ring(N=100; U = 1.0, xi=0.0, xf=10.0)
    ...
    #
    return ring(N,Δt,X_,ΔX_,U_,∇U_,Σ_,S_,0.0)
end
